...
public class NirslandsMinecraftDlcModModItems {
	...
	public static final RegistryObject<Item> STAR_SHARDS_BLOCK = block(NirslandsMinecraftDlcModModBlocks.STAR_SHARDS_BLOCK, NirslandsMinecraftDlcModModTabs.TAB_NIRSLANDS_DLC_MOD);
	public static final RegistryObject<Item> STAR_SHARDS_ORE = block(NirslandsMinecraftDlcModModBlocks.STAR_SHARDS_ORE, NirslandsMinecraftDlcModModTabs.TAB_NIRSLANDS_DLC_MOD);
	public static final RegistryObject<Item> STAR_BRICKS = block(NirslandsMinecraftDlcModModBlocks.STAR_BRICKS, NirslandsMinecraftDlcModModTabs.TAB_NIRSLANDS_DLC_MOD);
	public static final RegistryObject<Item> STAR_BRICKS_STAIRS = block(NirslandsMinecraftDlcModModBlocks.STAR_BRICKS_STAIRS, NirslandsMinecraftDlcModModTabs.TAB_NIRSLANDS_DLC_MOD);
	public static final RegistryObject<Item> STAR_BRICKS_SLABS = block(NirslandsMinecraftDlcModModBlocks.STAR_BRICKS_SLABS, NirslandsMinecraftDlcModModTabs.TAB_NIRSLANDS_DLC_MOD);
	public static final RegistryObject<Item> STAT_BRICK_WALL = block(NirslandsMinecraftDlcModModBlocks.STAT_BRICK_WALL, NirslandsMinecraftDlcModModTabs.TAB_NIRSLANDS_DLC_MOD);
	...
	public static final RegistryObject<Item> POISONED_NETHERACK = block(NirslandsMinecraftDlcModModBlocks.POISONED_NETHERACK, NirslandsMinecraftDlcModModTabs.TAB_NIRSLANDS_DLC_MOD);
	public static final RegistryObject<Item> ACID_BUCKET = REGISTRY.register("acid_bucket", () -> new AcidItem());
	public static final RegistryObject<Item> POISONED_NETHER_BRICKS = block(NirslandsMinecraftDlcModModBlocks.POISONED_NETHER_BRICKS, NirslandsMinecraftDlcModModTabs.TAB_NIRSLANDS_DLC_MOD);
	public static final RegistryObject<Item> POISONED_NETHERRACK_BRICKS_STAIRS = block(NirslandsMinecraftDlcModModBlocks.POISONED_NETHERRACK_BRICKS_STAIRS, NirslandsMinecraftDlcModModTabs.TAB_NIRSLANDS_DLC_MOD);
	public static final RegistryObject<Item> POISONED_NETHERACK_BRICKS_FENCE = block(NirslandsMinecraftDlcModModBlocks.POISONED_NETHERACK_BRICKS_FENCE, NirslandsMinecraftDlcModModTabs.TAB_NIRSLANDS_DLC_MOD);
	...
	public static final RegistryObject<Item> ENDERITE_BLOCK = block(NirslandsMinecraftDlcModModBlocks.ENDERITE_BLOCK, NirslandsMinecraftDlcModModTabs.TAB_NIRSLANDS_DLC_MOD);
	public static final RegistryObject<Item> RAW_ENDERITE_BLOCK = block(NirslandsMinecraftDlcModModBlocks.RAW_ENDERITE_BLOCK, NirslandsMinecraftDlcModModTabs.TAB_NIRSLANDS_DLC_MOD);
	public static final RegistryObject<Item> ENDERITE_ORE = block(NirslandsMinecraftDlcModModBlocks.ENDERITE_ORE, NirslandsMinecraftDlcModModTabs.TAB_NIRSLANDS_DLC_MOD);
	public static final RegistryObject<Item> ENDERITE_BRICKS = block(NirslandsMinecraftDlcModModBlocks.ENDERITE_BRICKS, NirslandsMinecraftDlcModModTabs.TAB_NIRSLANDS_DLC_MOD);
	public static final RegistryObject<Item> ENDERITE_BRICKS_STAIRS = block(NirslandsMinecraftDlcModModBlocks.ENDERITE_BRICKS_STAIRS, NirslandsMinecraftDlcModModTabs.TAB_NIRSLANDS_DLC_MOD);
	public static final RegistryObject<Item> ENDERITE_BRICKS_SLABS = block(NirslandsMinecraftDlcModModBlocks.ENDERITE_BRICKS_SLABS, NirslandsMinecraftDlcModModTabs.TAB_NIRSLANDS_DLC_MOD);
	public static final RegistryObject<Item> ENDERITE_BRICK_WALL = block(NirslandsMinecraftDlcModModBlocks.ENDERITE_BRICK_WALL, NirslandsMinecraftDlcModModTabs.TAB_NIRSLANDS_DLC_MOD);
