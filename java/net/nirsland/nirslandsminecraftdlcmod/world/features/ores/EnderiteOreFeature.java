...
public class EnderiteOreFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("nirslands_minecraft_dlc_mod:enderite_ore", FEATURE, new OreConfiguration(EnderiteOreFeatureRuleTest.INSTANCE, NirslandsMinecraftDlcModModBlocks.ENDERITE_ORE.get().defaultBlockState(), 4));
