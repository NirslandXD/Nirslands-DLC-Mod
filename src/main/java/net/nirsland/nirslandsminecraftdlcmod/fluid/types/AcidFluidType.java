...
package net.nirsland.nirslandsminecraftdlcmod.fluid.types;
...
public class AcidFluidType extends FluidType {
	...
	public void initializeClient(Consumer<IClientFluidTypeExtensions> consumer) {
		consumer.accept(new IClientFluidTypeExtensions() {
			private static final ResourceLocation STILL_TEXTURE = new ResourceLocation("nirslands_minecraft_dlc_mod:blocks/acidstill"), FLOWING_TEXTURE = new ResourceLocation("nirslands_minecraft_dlc_mod:blocks/acidflow");
