...
public class StarForceKeyOnKeyPressedProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		if (entity == null)
			return;
		if ((entity.getCapability(NirslandsMinecraftDlcModModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new NirslandsMinecraftDlcModModVariables.PlayerVariables())).Cooldown == false
				&& (entity instanceof LivingEntity _livEnt ? _livEnt.hasEffect(NirslandsMinecraftDlcModModMobEffects.STAR_FORCE.get()) : false)) {
