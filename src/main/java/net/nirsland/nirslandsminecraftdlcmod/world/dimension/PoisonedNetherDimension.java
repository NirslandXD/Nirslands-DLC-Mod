...
package net.nirsland.nirslandsminecraftdlcmod.world.dimension;
...
public class PoisonedNetherDimension {
	@Mod.EventBusSubscriber(bus = Mod.EventBusSubscriber.Bus.MOD)
	public static class Fixers {
		@SubscribeEvent
		public static void registerFillerBlocks(FMLCommonSetupEvent event) {
			Set<Block> replaceableBlocks = new HashSet<>();
			replaceableBlocks.add(NirslandsMinecraftDlcModModBlocks.POISONED_NETHERACK.get());
			replaceableBlocks.add(NirslandsMinecraftDlcModModBlocks.POISONED_NETHERACK.get());
			replaceableBlocks.add(NirslandsMinecraftDlcModModBlocks.POISONED_NETHERACK.get());
			event.enqueueWork(() -> {
		...
		public static void registerDimensionSpecialEffects(FMLClientSetupEvent event) {
			...
			event.enqueueWork(() -> DimensionSpecialEffects.EFFECTS.put(new ResourceLocation("nirslands_minecraft_dlc_mod:poisoned_nether"), customEffect));
		}
	}
}
