...
public class EnderiteOreFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("nirslands_minecraft_dlc_mod:enderite_ore", FEATURE,
				new OreConfiguration(List.of(OreConfiguration.target(new BlockStateMatchTest(Blocks.END_STONE.defaultBlockState()), NirslandsMinecraftDlcModModBlocks.ENDERITE_ORE.get().defaultBlockState())), 4));
		PLACED_FEATURE = PlacementUtils.register("nirslands_minecraft_dlc_mod:enderite_ore", CONFIGURED_FEATURE,
				List.of(CountPlacement.of(2), InSquarePlacement.spread(), HeightRangePlacement.uniform(VerticalAnchor.absolute(20), VerticalAnchor.absolute(64)), BiomeFilter.biome()));
		return FEATURE;
	}
