...
public class NirslandsMinecraftDlcModModSounds {
	...
	public static final RegistryObject<SoundEvent> STARFIGHT = REGISTRY.register("starfight", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation("nirslands_minecraft_dlc_mod", "starfight")));
}
